...
<img
  ...
  src="/images/LLD/design-patterns.png"
  alt="Design Patterns"
/>

## Overview

Design patterns are reusable solutions to common problems in software design. They're templates that help you write flexible, maintainable code.
...
**Use When**: Database connections, Configuration, Logging, Thread pools
...
<Warning>
**Don't over-engineer!** Use patterns when they solve real problems, not to show off. Simple code is often better than pattern-heavy code.
</Warning>
