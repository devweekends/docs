...
❌ "This class saves users AND sends emails AND logs activity"
...
# 🎉 Now we have 6 focused classes instead of 1 monster!
...
<Card title="Continue to Open/Closed Principle →" icon="arrow-right" href="/lld/solid/ocp">
