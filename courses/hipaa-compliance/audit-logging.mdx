...
│  WHAT TO LOG                           WHY                                  │
│  ───────────                           ───                                  │
│  • User logins/logouts                 • Detect unauthorized access         │
│  • PHI access (read/view)              • Track who saw what                 │
│  • PHI modifications                   • Audit trail for changes            │
│  • PHI disclosures                     • Patient accounting of disclosures  │
│  • Failed access attempts              • Detect attacks                     │
│  • System configuration changes        • Change management                  │
│  • User account changes                • Access control audit               │
│  • Encryption key operations           • Key management audit               │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
