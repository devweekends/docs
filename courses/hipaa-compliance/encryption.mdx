...
│                                                                              │
│  ┌─────────────────┐                                                        │
│  │  Master Key     │  ◄── Stored in HSM / AWS KMS / HashiCorp Vault        │
│  │  (KEK)          │                                                        │
│  └────────┬────────┘                                                        │
│           │                                                                  │
│           │ encrypts                                                        │
│           ▼                                                                  │
│  ┌─────────────────┐                                                        │
│  │  Data Encryption│  ◄── Unique per record/file                           │
│  │  Key (DEK)      │      Stored encrypted alongside data                  │
│  └────────┬────────┘                                                        │
│           │                                                                  │
│           │ encrypts                                                        │
│           ▼                                                                  │
│  ┌─────────────────┐                                                        │
│  │   PHI Data      │  ◄── Patient records, medical data, etc.             │
│  │   (Ciphertext)  │                                                        │
│  └─────────────────┘                                                        │
│                                                                              │
│  BENEFITS:                                                                  │
│  • Key rotation without re-encrypting all data                              │
│  • Cryptographic isolation between records                                  │
