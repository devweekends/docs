...
│  │                  │    │                  │    │                  │       │
│  │  • Who can       │    │  • Technical     │    │  • Notification  │       │
│  │    access PHI    │    │    safeguards    │    │    requirements  │       │
│  │  • Patient       │    │  • Physical      │    │  • Timeline      │       │
│  │    rights        │    │    safeguards    │    │  • Documentation │       │
│  │  • Disclosure    │    │  • Admin         │    │  • Penalties     │       │
│  │    limits        │    │    safeguards    │    │                  │       │
│  └──────────────────┘    └──────────────────┘    └──────────────────┘       │
│                                                                              │
│  ┌──────────────────────────────────────────────────────────────────┐       │
│  │              HITECH ACT (2009 Enhancement)                        │       │
│  │  • Increased penalties ($50K - $1.9M per violation)               │       │
│  │  • Extended to Business Associates                                │       │
│  │  • Breach notification to media for 500+ individuals              │       │
│  └──────────────────────────────────────────────────────────────────┘       │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│  ───────────────────           ────────────           ──────────────        │
│  • Hospitals                   • Health insurance     • Billing services    │
│  • Clinics                     • HMOs                 • Claims processing   │
│  • Doctors                     • Medicare             • Data conversion     │
│  • Pharmacies                  • Medicaid                                   │
│  • Dentists                    • Company health                             │
│  • Psychologists                 plans                                      │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
                                      │
...
│  • Performs functions on behalf of a Covered Entity                         │
│                                                                              │
│  EXAMPLES:                                                                  │
│  ─────────                                                                  │
...
│     │                           │                             │             │
│     ▼                           ▼                             ▼             │
│  Day 0                    60 Days Max                   Depends on Size     │
│  "knew or should                                                            │
│   have known"                                                               │
│                                                                              │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  AFFECTED INDIVIDUALS                 HHS (OCR)                             │
│  ────────────────────                 ─────────                             │
│  • Within 60 days of discovery        • <500: Annual log                    │
│  • Written notification (mail)        • ≥500: Within 60 days                │
│  • Or email if individual agrees                                            │
│  • Substitute notice if no contact                                          │
│                                                                              │
│  MEDIA (if ≥500 in a state)           STATE ATTORNEY GENERAL               │
│  ──────────────────────────           ──────────────────────               │
│  • Prominent media outlets            • Required in some states             │
│  • Within 60 days                     • Varies by state law                 │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
