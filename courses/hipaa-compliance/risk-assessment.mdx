...
<AccordionGroup>
  <Accordion title="Your organization completed a risk assessment 2 years ago. The CTO says it is still valid because nothing major has changed. Is this defensible in an audit?">
    **Strong Answer:**
    ...
    - The penalty precedent is clear: the $875K fine against a dental practice chain was specifically for failing to conduct a risk assessment for 3+ years. OCR routinely cites stale risk assessments as evidence of willful neglect, which is the highest penalty tier (minimum $50,000 per violation).
