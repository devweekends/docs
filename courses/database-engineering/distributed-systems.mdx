...
│   Follower B:   [1][2][3]        (catching up)                              │
│                                                                              │
│   Commit Rule:                                                               │
│   Entry is committed when replicated to majority                            │
│   Committed entries are durable and won't be overwritten                    │
│                                                                              │
│   Safety Properties:                                                         │
│   • Election Safety: At most one leader per term                            │
│   • Leader Append-Only: Leader never overwrites its log                     │
│   • Log Matching: If two logs have same entry, all prior entries match      │
...
│                                                                              │
│   Each Range:                                                                │
│   • Has its own Raft group (3-5 replicas)                                   │
│   • Stores data in RocksDB (LSM tree)                                       │
│   • Can split when too large                                                │
│   • Can merge when too small                                                │
│                                                                              │
...
│   • Zone constraints (regions, racks)                                       │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
