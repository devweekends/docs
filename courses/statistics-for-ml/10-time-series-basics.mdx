...
**Analogy**: Regular ML is like looking at a bag of random photographs -- each one is independent, and you can shuffle them freely. Time series is like watching a movie -- each frame only makes sense in sequence, and what happened 5 seconds ago tells you a lot about what is happening now. Shuffling the frames destroys the information.
