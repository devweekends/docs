...
<Accordion title="Question 2: R² Interpretation (Amazon)">
**Question**: Your model predicting delivery time has R² = 0.65. A colleague says "65% accuracy isn't good enough." Is this correct?

<Tip>
**Answer**: No, this is a common misconception.

R² = 0.65 means the model explains 65% of the **variance** in delivery time, not that it's "65% accurate."

This could be quite good depending on context:
- For predicting human behavior, R² = 0.65 is excellent
...
```python
# Example: R² = 0.65, but RMSE = 5 minutes
