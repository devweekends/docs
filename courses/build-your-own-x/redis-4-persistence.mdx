...
This chapter teaches one of the most fundamental trade-offs in all of systems engineering: **durability vs. performance**. Every write to disk costs time. The question is _when_ you pay that cost and _how much data you are willing to lose_ if the power goes out. RDB and AOF represent two different answers to this question, and understanding both will inform your thinking about databases, message queues, and any system that claims to "persist" data.
