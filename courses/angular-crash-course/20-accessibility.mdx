...
// LiveAnnouncer creates an invisible aria-live region and injects text into it.
// Screen readers watch these regions and read changes aloud to the user.
// This is essential for dynamic content changes that sighted users notice
// visually but screen reader users would otherwise miss entirely.
...
export class NotificationService {
  ...
  // 'assertive' interrupts immediately -- use only for urgent messages like errors.
