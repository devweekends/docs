...
<AccordionGroup>
  <Accordion title="When would you choose App Service over AKS for a production web application, and when would that choice be wrong?">
  ...
  <Accordion title="Your VMSS auto-scales at 70% CPU but new instances take 5 minutes to be healthy. Users see errors during scale-out. How do you fix this?">
    **Strong Candidate Answer:**
    ...
    **Follow-up: After optimization, instances start in 90 seconds but existing ones still hit 95% CPU during the gap. What else?**

    Deploy a minimum instance count at 120% of average traffic. The extra 20% costs $50/month but absorbs the burst. For mission-critical systems, combine pre-provisioned headroom with container-based scaling.
  </Accordion>

  <Accordion title="Compare IaaS, PaaS, and Serverless for a real-time pipeline ingesting 10 million events per day. Which do you choose?">
    **Strong Candidate Answer:**
    ...
    **Follow-up: At 1 billion events/day, does PaaS still make sense?**

    At 1B events/day, PaaS costs ~$10,500/month. Comparable IaaS is ~$8,000/month in VMs but add $12,000/month engineering overhead. PaaS remains cheaper TCO until approximately 5B events/day, when dedicated infrastructure with a platform team becomes more economical.
  </Accordion>
</AccordionGroup>
