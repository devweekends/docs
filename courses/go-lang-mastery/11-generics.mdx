...
<AccordionGroup>
  ...
  <Accordion title="What are the performance implications of generics?">
...
<AccordionGroup>
  <Accordion title="Go resisted adding generics for over a decade. What was the argument against them, and what changed that made the Go team finally add them in 1.18?">
    **Strong Answer:**
