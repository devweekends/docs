...
│  φ = 3 → 99.9% confident node is alive                                      │
│                                                                              │
│  Adaptive threshold based on historical heartbeat intervals                 │
│                                                                              │
│  GOSSIP-BASED                                                               │
│  ────────────                                                               │
│  Nodes randomly exchange state about other nodes                            │
│  "I last heard from C at time T"                                            │
│                                                                              │
│  More scalable, eventually consistent view of cluster state                 │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│                                                                              │
│  [1,0,0] < [2,1,0]  ✓ (A happened before)                                  │
│  [2,0,0] || [1,1,2] ✗ (Concurrent - neither before the other)              │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  You can have at most 2 of these 3 during a network partition:             │
│                                                                              │
│                        Consistency                                          │
│                           /\                                                │
│                          /  \                                               │
...
│  CA is only possible in single-node systems (no distribution).             │
│                                                                              │
│  CP Examples: Spanner, HBase, MongoDB (primary reads)                       │
