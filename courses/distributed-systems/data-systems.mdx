...
│  PROBLEM WITH HASH % N:                                                     │
│  ──────────────────────                                                     │
│  Adding/removing node = rehash almost everything                            │
│                                                                              │
│  SOLUTION: Hash ring                                                        │
│  ────────────────────                                                       │
│                                                                              │
...
│  ALGORITHM:                                                                 │
│  ──────────                                                                 │
│  1. Hash nodes onto ring (0-360 degrees or 0-2^32)                         │
│  2. Hash key onto ring                                                      │
│  3. Walk clockwise to find first node                                       │
│                                                                              │
│  ADDING NODE:                                                               │
│  ────────────                                                               │
│  Only keys between new node and predecessor move                            │
│  Expected: 1/N of keys (minimal disruption!)                                │
│                                                                              │
│  REMOVING NODE:                                                             │
│  ──────────────                                                             │
│  Only that node's keys move to successor                                    │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
