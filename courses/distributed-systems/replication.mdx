...
│     "Answer to question" arrives before "Question"                          │
│                                                                              │
│  SOLUTIONS:                                                                 │
│  ──────────                                                                 │
│  • Read-your-writes: Read from leader for recently written data             │
│  • Monotonic reads: Stick user to same replica (session affinity)           │
│  • Consistent prefix: Use causally consistent reads                         │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│  LIMITATIONS:                                                               │
│  ────────────                                                               │
│  Even with quorums, you can read stale data if:                            │
│  • Using sloppy quorums                                                     │
│  • Concurrent writes (no single "latest")                                   │
│  • Write succeeded on some but client didn't know                          │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
