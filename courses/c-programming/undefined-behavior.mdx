...
Think of it like a contract: you promised the compiler your code would never have UB, and in exchange the compiler promised to make your code fast. When you break your side of the contract, the compiler's optimizations -- which were valid under the contract -- produce nonsensical results.
...
// Cost: near-zero (the compiler often optimizes away redundant initialization)
// Benefit: eliminates an entire class of UB (uninitialized reads)
int x = 0;
char buffer[100] = {0};
