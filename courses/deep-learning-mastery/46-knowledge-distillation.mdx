...
Think of it this way: soft-target distillation is like learning from a teacher's final answers on an exam. Feature-based distillation is like also seeing the teacher's scratch work -- the intermediate reasoning steps that led to those answers.
