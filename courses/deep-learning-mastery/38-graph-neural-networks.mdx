...
A graph is simply a collection of **nodes** (things) connected by **edges** (relationships). This deceptively simple structure can represent an enormous range of real-world data:
