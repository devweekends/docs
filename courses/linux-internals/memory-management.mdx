...
│     1. Process accesses virtual address (e.g., code or mmap)                │
│     2. CPU triggers Page Fault (Present bit = 0)                            │
│     3. Kernel looks up VMA (Virtual Memory Area)                            │
│     4. Kernel allocates physical page (from Buddy Allocator)                │
│     5. Kernel fills page (reads from disk or zeroes it)                     │
│     6. Kernel updates Page Table (Present bit = 1)                          │
│     7. Kernel resumes process (instruction retries)                         │
│                                                                              │
