...
<Frame>
  <img src="/images/courses/linux-internals/io-subsystem-concept.svg" alt="Linux I/O Subsystem - Block layer, schedulers, and the journey from VFS to disk" />
</Frame>
...
![Linux I/O Stack](/images/courses/linux-io-stack.svg)
