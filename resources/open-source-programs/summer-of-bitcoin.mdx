...
1. **Programming proficiency** — Can you actually code what you're proposing?
2. **Security-focused thinking** — Bitcoin projects demand security awareness
3. **Understanding of Bitcoin's technical foundations** — Blocks, transactions, consensus
4. **Quality of proposal** — Clear, detailed, and realistic
5. **Bootcamp challenge performance** — How well you handled the learning phase
6. **Proactive contributions** — Did you engage with the project before applying?
