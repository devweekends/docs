...
<AccordionGroup>
  <Accordion title="What is Python and its key features?">
    ...
    **Red flag answer:** "Python is easy to learn and has lots of libraries." This is a junior answer that shows no depth.
    ...
    **Follow-up:**
    ...
    - "How does Python's strong dynamic typing affect how you design a large codebase with 50+ engineers?"
...
<Accordion title="What are Python's built-in data types?">
    ...
    **Follow-up:**
    - "Why can you use a tuple as a dictionary key but not a list?"
    - "What happens when you put a `float('nan')` into a set? Can you have duplicate NaN values?"
    - "When would you use `bytearray` over `bytes`?"
</Accordion>
...
<Accordion title="What is the difference between lists and tuples?">
    ...
    **Follow-up:**
    ...
    - "When would you use a `namedtuple` vs a `dataclass`? What are the trade-offs?"
    - "You have a function returning multiple values. Should you return a tuple or a list? Why?"
</Accordion>
...
<Accordion title="Explain Python's mutable and immutable types">
    ...
    **Follow-up:**
    - "Show me a bug caused by mutability that would be hard to catch in code review."
    - "How does string immutability affect performance when building a large string in a loop? What is the fix?"
    - "Is a tuple always immutable? What about `tuple([mutable_list])`?"
</Accordion>
...
<Accordion title="What is the difference between global and local variables? (LEGB rule)">
    ...
    **Follow-up:**
    - "What is an `UnboundLocalError` and when does it occur? Show me a 3-line function that triggers it."
    - "When would you use `nonlocal` vs `global`?"
    - "In a production Flask app, how would you manage configuration instead of using global variables?"
</Accordion>
