...
<Accordion title="AI-Assisted Engineering Lens: Processes and Threads">
...
<svg viewBox="0 0 800 380" xmlns="http://www.w3.org/2000/svg" style={{maxWidth: '800px', width: '100%'}}>
  <defs>
    <marker id="arrowPT" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <path fill="#e94560" d="M0,0 L8,3 L0,6 Z"/>
    </marker>
  </defs>

  {/* Title */}
  <text x="400" y="28" textAnchor="middle" fill="#f5f5f5" fontSize="18" fontWeight="bold" fontFamily="system-ui, sans-serif">Process vs Thread: Memory Layout</text>

  {/* Process boundary */}
  <rect x="30" y="45" width="740" height="320" rx="12" fill="#1a1a2e" stroke="#0f3460" strokeWidth="2"/>
  <text x="400" y="72" textAnchor="middle" fill="#e94560" fontSize="15" fontWeight="bold" fontFamily="system-ui, sans-serif">Process (PID 1234) — Virtual Address Space</text>

  {/* Shared Heap area */}
  <rect x="60" y="88" width="680" height="90" rx="8" fill="#16213e" stroke="#4ecca3" strokeWidth="2" strokeDasharray="6,3"/>
  <text x="400" y="112" textAnchor="middle" fill="#4ecca3" fontSize="14" fontWeight="bold" fontFamily="system-ui, sans-serif">Shared Memory (Heap, Global Data, File Descriptors)</text>
  <rect x="90" y="122" width="140" height="40" rx="6" fill="#0f3460" stroke="#4ecca3" strokeWidth="1"/>
  <text x="160" y="147" textAnchor="middle" fill="#f5f5f5" fontSize="12" fontFamily="system-ui, sans-serif">Heap Objects</text>
  <rect x="250" y="122" width="140" height="40" rx="6" fill="#0f3460" stroke="#4ecca3" strokeWidth="1"/>
  <text x="320" y="147" textAnchor="middle" fill="#f5f5f5" fontSize="12" fontFamily="system-ui, sans-serif">Global Variables</text>
  <rect x="410" y="122" width="140" height="40" rx="6" fill="#0f3460" stroke="#4ecca3" strokeWidth="1"/>
  <text x="480" y="147" textAnchor="middle" fill="#f5f5f5" fontSize="12" fontFamily="system-ui, sans-serif">Open FDs / Sockets</text>
  <rect x="570" y="122" width="140" height="40" rx="6" fill="#0f3460" stroke="#4ecca3" strokeWidth="1"/>
  <text x="640" y="147" textAnchor="middle" fill="#f5f5f5" fontSize="12" fontFamily="system-ui, sans-serif">Code (Text Segment)</text>

  {/* Thread 1 */}
  <rect x="60" y="200" width="200" height="150" rx="8" fill="#533483" stroke="#e94560" strokeWidth="2"/>
  <text x="160" y="224" textAnchor="middle" fill="#f5f5f5" fontSize="14" fontWeight="bold" fontFamily="system-ui, sans-serif">Thread 1 (Main)</text>
  <rect x="80" y="236" width="160" height="32" rx="6" fill="#1a1a2e" stroke="#e94560" strokeWidth="1"/>
  <text x="160" y="257" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Stack (1-8 MB)</text>
  <rect x="80" y="276" width="160" height="32" rx="6" fill="#1a1a2e" stroke="#e94560" strokeWidth="1"/>
  <text x="160" y="297" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Registers + PC</text>
  <rect x="80" y="316" width="160" height="24" rx="6" fill="#1a1a2e" stroke="#e94560" strokeWidth="1"/>
  <text x="160" y="333" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">Thread-local Storage</text>

  {/* Thread 2 */}
  <rect x="300" y="200" width="200" height="150" rx="8" fill="#533483" stroke="#e94560" strokeWidth="2"/>
  <text x="400" y="224" textAnchor="middle" fill="#f5f5f5" fontSize="14" fontWeight="bold" fontFamily="system-ui, sans-serif">Thread 2</text>
  <rect x="320" y="236" width="160" height="32" rx="6" fill="#1a1a2e" stroke="#e94560" strokeWidth="1"/>
  <text x="400" y="257" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Stack (1-8 MB)</text>
  <rect x="320" y="276" width="160" height="32" rx="6" fill="#1a1a2e" stroke="#e94560" strokeWidth="1"/>
  <text x="400" y="297" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Registers + PC</text>
  <rect x="320" y="316" width="160" height="24" rx="6" fill="#1a1a2e" stroke="#e94560" strokeWidth="1"/>
  <text x="400" y="333" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">Thread-local Storage</text>

  {/* Thread 3 */}
  <rect x="540" y="200" width="200" height="150" rx="8" fill="#533483" stroke="#e94560" strokeWidth="2"/>
  <text x="640" y="224" textAnchor="middle" fill="#f5f5f5" fontSize="14" fontWeight="bold" fontFamily="system-ui, sans-serif">Thread 3</text>
  <rect x="560" y="236" width="160" height="32" rx="6" fill="#1a1a2e" stroke="#e94560" strokeWidth="1"/>
  <text x="640" y="257" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Stack (1-8 MB)</text>
  <rect x="560" y="276" width="160" height="32" rx="6" fill="#1a1a2e" stroke="#e94560" strokeWidth="1"/>
  <text x="640" y="297" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Registers + PC</text>
  <rect x="560" y="316" width="160" height="24" rx="6" fill="#1a1a2e" stroke="#e94560" strokeWidth="1"/>
  <text x="640" y="333" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">Thread-local Storage</text>

  {/* Connecting arrows from shared to threads */}
  <line x1="160" y1="178" x2="160" y2="198" stroke="#4ecca3" strokeWidth="1.5" strokeDasharray="4,3"/>
  <line x1="400" y1="178" x2="400" y2="198" stroke="#4ecca3" strokeWidth="1.5" strokeDasharray="4,3"/>
  <line x1="640" y1="178" x2="640" y2="198" stroke="#4ecca3" strokeWidth="1.5" strokeDasharray="4,3"/>

  {/* Legend */}
  <rect x="100" y="360" width="12" height="12" rx="2" fill="#4ecca3" opacity="0.4"/>
  <text x="118" y="371" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">= Shared across threads</text>
  <rect x="350" y="360" width="12" height="12" rx="2" fill="#533483"/>
  <text x="368" y="371" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">= Private per thread (own stack, registers, TLS)</text>
</svg>
</div>
...
<svg viewBox="0 0 800 380" xmlns="http://www.w3.org/2000/svg" style={{maxWidth: '800px', width: '100%'}}>
  <defs>
    <marker id="arrowSch" markerWidth="7" markerHeight="5" refX="7" refY="2.5" orient="auto">
      <path d="M0,0 L7,2.5 L0,5 Z" fill="#f5f5f5"/>
    </marker>
    <marker id="arrowCS" markerWidth="6" markerHeight="5" refX="6" refY="2.5" orient="auto">
      <path d="M0,0 L6,2.5 L0,5 Z" fill="#e94560"/>
    </marker>
  </defs>

  {/* Title */}
  <text x="400" y="26" textAnchor="middle" fill="#f5f5f5" fontSize="18" fontWeight="bold" fontFamily="system-ui, sans-serif">CPU Scheduling: Round Robin Timeline with Context Switches</text>

  {/* Ready Queue */}
  <rect x="20" y="48" width="160" height="135" rx="8" fill="#1a1a2e" stroke="#0f3460" strokeWidth="2"/>
  <text x="100" y="70" textAnchor="middle" fill="#0f3460" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">Ready Queue</text>

  <rect x="35" y="82" width="130" height="26" rx="6" fill="#533483" stroke="#533483" strokeWidth="1"/>
  <text x="100" y="100" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">P1 (web server)</text>

  <rect x="35" y="114" width="130" height="26" rx="6" fill="#0f3460" stroke="#0f3460" strokeWidth="1"/>
  <text x="100" y="132" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">P2 (database)</text>

  <rect x="35" y="146" width="130" height="26" rx="6" fill="#16213e" stroke="#4ecca3" strokeWidth="1"/>
  <text x="100" y="164" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">P3 (batch job)</text>

  {/* Arrow from queue to timeline */}
  <text x="210" y="105" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">dispatch</text>
  <line x1="180" y1="112" x2="235" y2="112" stroke="#f5f5f5" strokeWidth="1.5" markerEnd="url(#arrowSch)"/>

  {/* CPU label */}
  <rect x="240" y="48" width="540" height="40" rx="8" fill="#1a1a2e" stroke="#4ecca3" strokeWidth="2"/>
  <text x="510" y="73" textAnchor="middle" fill="#4ecca3" fontSize="14" fontWeight="bold" fontFamily="system-ui, sans-serif">CPU Core 0 — Execution Timeline</text>

  {/* Time axis */}
  <line x1="250" y1="140" x2="770" y2="140" stroke="#f5f5f5" strokeWidth="1.5" markerEnd="url(#arrowSch)"/>
  <text x="780" y="144" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">t</text>

  {/* Time markers */}
  <line x1="250" y1="136" x2="250" y2="144" stroke="#f5f5f5" strokeWidth="1"/>
  <text x="250" y="156" textAnchor="middle" fill="#888" fontSize="9" fontFamily="system-ui, sans-serif">0ms</text>

  <line x1="345" y1="136" x2="345" y2="144" stroke="#f5f5f5" strokeWidth="1"/>
  <text x="345" y="156" textAnchor="middle" fill="#888" fontSize="9" fontFamily="system-ui, sans-serif">10ms</text>

  <line x1="440" y1="136" x2="440" y2="144" stroke="#f5f5f5" strokeWidth="1"/>
  <text x="440" y="156" textAnchor="middle" fill="#888" fontSize="9" fontFamily="system-ui, sans-serif">20ms</text>

  <line x1="505" y1="136" x2="505" y2="144" stroke="#f5f5f5" strokeWidth="1"/>
  <text x="505" y="156" textAnchor="middle" fill="#888" fontSize="9" fontFamily="system-ui, sans-serif">27ms</text>

  <line x1="600" y1="136" x2="600" y2="144" stroke="#f5f5f5" strokeWidth="1"/>
  <text x="600" y="156" textAnchor="middle" fill="#888" fontSize="9" fontFamily="system-ui, sans-serif">37ms</text>

  <line x1="695" y1="136" x2="695" y2="144" stroke="#f5f5f5" strokeWidth="1"/>
  <text x="695" y="156" textAnchor="middle" fill="#888" fontSize="9" fontFamily="system-ui, sans-serif">47ms</text>

  {/* Timeline blocks */}
  {/* P1 running */}
  <rect x="250" y="96" width="90" height="36" rx="4" fill="#533483" stroke="#533483" strokeWidth="1"/>
  <text x="295" y="118" textAnchor="middle" fill="#f5f5f5" fontSize="12" fontWeight="bold" fontFamily="system-ui, sans-serif">P1 runs</text>

  {/* Context switch 1 */}
  <rect x="340" y="96" width="10" height="36" rx="2" fill="#e94560"/>
  <line x1="345" y1="92" x2="345" y2="80" stroke="#e94560" strokeWidth="1" markerEnd="url(#arrowCS)"/>
  <text x="345" y="76" textAnchor="middle" fill="#e94560" fontSize="8" fontFamily="system-ui, sans-serif">ctx switch</text>

  {/* P2 running */}
  <rect x="350" y="96" width="85" height="36" rx="4" fill="#0f3460" stroke="#0f3460" strokeWidth="1"/>
  <text x="393" y="118" textAnchor="middle" fill="#f5f5f5" fontSize="12" fontWeight="bold" fontFamily="system-ui, sans-serif">P2 runs</text>

  {/* Context switch 2 */}
  <rect x="435" y="96" width="10" height="36" rx="2" fill="#e94560"/>
  <line x1="440" y1="92" x2="440" y2="80" stroke="#e94560" strokeWidth="1" markerEnd="url(#arrowCS)"/>
  <text x="440" y="76" textAnchor="middle" fill="#e94560" fontSize="8" fontFamily="system-ui, sans-serif">ctx switch</text>

  {/* P3 running (shorter — I/O blocked early) */}
  <rect x="445" y="96" width="55" height="36" rx="4" fill="#16213e" stroke="#4ecca3" strokeWidth="1.5"/>
  <text x="473" y="118" textAnchor="middle" fill="#f5f5f5" fontSize="12" fontWeight="bold" fontFamily="system-ui, sans-serif">P3</text>

  {/* I/O block indicator */}
  <line x1="500" y1="132" x2="500" y2="170" stroke="#e94560" strokeWidth="1" strokeDasharray="3,2"/>
  <text x="502" y="180" textAnchor="start" fill="#e94560" fontSize="9" fontFamily="system-ui, sans-serif">P3 blocks on I/O</text>

  {/* Context switch 3 */}
  <rect x="500" y="96" width="10" height="36" rx="2" fill="#e94560"/>

  {/* P1 runs again */}
  <rect x="510" y="96" width="85" height="36" rx="4" fill="#533483" stroke="#533483" strokeWidth="1"/>
  <text x="553" y="118" textAnchor="middle" fill="#f5f5f5" fontSize="12" fontWeight="bold" fontFamily="system-ui, sans-serif">P1 runs</text>

  {/* Context switch 4 */}
  <rect x="595" y="96" width="10" height="36" rx="2" fill="#e94560"/>

  {/* P2 runs again */}
  <rect x="605" y="96" width="85" height="36" rx="4" fill="#0f3460" stroke="#0f3460" strokeWidth="1"/>
  <text x="648" y="118" textAnchor="middle" fill="#f5f5f5" fontSize="12" fontWeight="bold" fontFamily="system-ui, sans-serif">P2 runs</text>

  {/* Context switch 5 */}
  <rect x="690" y="96" width="10" height="36" rx="2" fill="#e94560"/>

  {/* P3 back from I/O */}
  <rect x="700" y="96" width="60" height="36" rx="4" fill="#16213e" stroke="#4ecca3" strokeWidth="1.5"/>
  <text x="730" y="118" textAnchor="middle" fill="#f5f5f5" fontSize="12" fontWeight="bold" fontFamily="system-ui, sans-serif">P3</text>

  {/* State transition boxes */}
  <text x="400" y="215" textAnchor="middle" fill="#f5f5f5" fontSize="14" fontWeight="bold" fontFamily="system-ui, sans-serif">Process State Transitions During Scheduling</text>

  {/* State: Running */}
  <rect x="310" y="230" width="120" height="44" rx="8" fill="#4ecca3" opacity="0.2" stroke="#4ecca3" strokeWidth="2"/>
  <text x="370" y="257" textAnchor="middle" fill="#4ecca3" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">RUNNING</text>

  {/* State: Ready */}
  <rect x="80" y="230" width="120" height="44" rx="8" fill="#533483" opacity="0.2" stroke="#533483" strokeWidth="2"/>
  <text x="140" y="257" textAnchor="middle" fill="#f5f5f5" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">READY</text>

  {/* State: Waiting/Blocked */}
  <rect x="560" y="230" width="140" height="44" rx="8" fill="#e94560" opacity="0.15" stroke="#e94560" strokeWidth="2"/>
  <text x="630" y="257" textAnchor="middle" fill="#e94560" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">WAITING (I/O)</text>

  {/* Arrows between states */}
  <path d="M200,245 C240,235 270,235 310,245" fill="none" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrowSch)"/>
  <text x="255" y="232" textAnchor="middle" fill="#4ecca3" fontSize="10" fontFamily="system-ui, sans-serif">dispatch</text>

  <path d="M310,265 C270,275 240,275 200,265" fill="none" stroke="#533483" strokeWidth="1.5"/>
  <text x="255" y="287" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">quantum expires</text>
  <circle cx="202" cy="264" r="3" fill="#533483"/>

  <path d="M430,252 C480,252 510,252 558,252" fill="none" stroke="#e94560" strokeWidth="1.5" markerEnd="url(#arrowCS)"/>
  <text x="495" y="244" textAnchor="middle" fill="#e94560" fontSize="10" fontFamily="system-ui, sans-serif">I/O request</text>

  <path d="M560,270 C450,310 250,310 200,270" fill="none" stroke="#4ecca3" strokeWidth="1.5"/>
  <text x="380" y="318" textAnchor="middle" fill="#4ecca3" fontSize="10" fontFamily="system-ui, sans-serif">I/O complete → back to ready queue</text>
  <circle cx="202" cy="269" r="3" fill="#4ecca3"/>

  {/* Legend */}
  <rect x="80" y="345" width="16" height="12" rx="2" fill="#e94560"/>
  <text x="102" y="356" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Context switch (~1-10 us overhead)</text>
  <rect x="340" y="345" width="16" height="12" rx="2" fill="#533483"/>
  <text x="362" y="356" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">P1</text>
  <rect x="400" y="345" width="16" height="12" rx="2" fill="#0f3460"/>
  <text x="422" y="356" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">P2</text>
  <rect x="455" y="345" width="16" height="12" rx="2" fill="#16213e" stroke="#4ecca3" strokeWidth="1"/>
  <text x="477" y="356" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">P3</text>
  <text x="530" y="356" fill="#888" fontSize="10" fontFamily="system-ui, sans-serif">Quantum = 10ms (Round Robin)</text>
</svg>
</div>
...
<svg viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg" style={{maxWidth: '800px', width: '100%'}}>
  <defs>
    <marker id="arrowVM" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <path d="M0,0 L8,3 L0,6 Z" fill="#4ecca3"/>
    </marker>
    <marker id="arrowFault" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <path d="M0,0 L8,3 L0,6 Z" fill="#e94560"/>
    </marker>
  </defs>

  {/* Title */}
  <text x="400" y="28" textAnchor="middle" fill="#f5f5f5" fontSize="18" fontWeight="bold" fontFamily="system-ui, sans-serif">Virtual Memory: Address Translation and Page Faults</text>

  {/* Virtual Address Space */}
  <rect x="20" y="50" width="180" height="310" rx="8" fill="#1a1a2e" stroke="#533483" strokeWidth="2"/>
  <text x="110" y="74" textAnchor="middle" fill="#533483" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">Virtual Address</text>
  <text x="110" y="90" textAnchor="middle" fill="#533483" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">Space (Process)</text>

  <rect x="35" y="105" width="150" height="34" rx="6" fill="#0f3460" stroke="#4ecca3" strokeWidth="1.5"/>
  <text x="110" y="126" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Page 0 (0x0000)</text>

  <rect x="35" y="147" width="150" height="34" rx="6" fill="#0f3460" stroke="#4ecca3" strokeWidth="1.5"/>
  <text x="110" y="168" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Page 1 (0x1000)</text>

  <rect x="35" y="189" width="150" height="34" rx="6" fill="#0f3460" stroke="#4ecca3" strokeWidth="1.5"/>
  <text x="110" y="210" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Page 2 (0x2000)</text>

  <rect x="35" y="231" width="150" height="34" rx="6" fill="#0f3460" stroke="#e94560" strokeWidth="1.5" strokeDasharray="5,3"/>
  <text x="110" y="252" textAnchor="middle" fill="#e94560" fontSize="11" fontFamily="system-ui, sans-serif">Page 3 (0x3000)</text>

  <rect x="35" y="273" width="150" height="34" rx="6" fill="#0f3460" stroke="#4ecca3" strokeWidth="1.5"/>
  <text x="110" y="294" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Page 4 (0x4000)</text>

  <rect x="35" y="315" width="150" height="34" rx="6" fill="#0f3460" stroke="#e94560" strokeWidth="1.5" strokeDasharray="5,3"/>
  <text x="110" y="336" textAnchor="middle" fill="#e94560" fontSize="11" fontFamily="system-ui, sans-serif">Page 5 (0x5000)</text>

  {/* Page Table */}
  <rect x="270" y="50" width="170" height="310" rx="8" fill="#1a1a2e" stroke="#0f3460" strokeWidth="2"/>
  <text x="355" y="74" textAnchor="middle" fill="#0f3460" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">Page Table</text>
  <text x="355" y="90" textAnchor="middle" fill="#0f3460" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">(MMU Lookup)</text>

  <rect x="282" y="105" width="146" height="34" rx="6" fill="#16213e" stroke="#4ecca3" strokeWidth="1"/>
  <text x="355" y="121" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">VP 0 → Frame 5</text>
  <text x="355" y="133" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">Valid | R/W</text>

  <rect x="282" y="147" width="146" height="34" rx="6" fill="#16213e" stroke="#4ecca3" strokeWidth="1"/>
  <text x="355" y="163" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">VP 1 → Frame 2</text>
  <text x="355" y="175" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">Valid | R/W</text>

  <rect x="282" y="189" width="146" height="34" rx="6" fill="#16213e" stroke="#4ecca3" strokeWidth="1"/>
  <text x="355" y="205" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">VP 2 → Frame 7</text>
  <text x="355" y="217" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">Valid | Read-only</text>

  <rect x="282" y="231" width="146" height="34" rx="6" fill="#16213e" stroke="#e94560" strokeWidth="1.5"/>
  <text x="355" y="247" textAnchor="middle" fill="#e94560" fontSize="10" fontWeight="bold" fontFamily="system-ui, sans-serif">VP 3 → INVALID</text>
  <text x="355" y="259" textAnchor="middle" fill="#e94560" fontSize="9" fontFamily="system-ui, sans-serif">Page Fault!</text>

  <rect x="282" y="273" width="146" height="34" rx="6" fill="#16213e" stroke="#4ecca3" strokeWidth="1"/>
  <text x="355" y="289" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">VP 4 → Frame 0</text>
  <text x="355" y="301" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">Valid | R/W</text>

  <rect x="282" y="315" width="146" height="34" rx="6" fill="#16213e" stroke="#e94560" strokeWidth="1.5"/>
  <text x="355" y="331" textAnchor="middle" fill="#e94560" fontSize="10" fontWeight="bold" fontFamily="system-ui, sans-serif">VP 5 → ON DISK</text>
  <text x="355" y="343" textAnchor="middle" fill="#e94560" fontSize="9" fontFamily="system-ui, sans-serif">Major Fault → Swap</text>

  {/* Physical Memory */}
  <rect x="510" y="50" width="150" height="220" rx="8" fill="#1a1a2e" stroke="#4ecca3" strokeWidth="2"/>
  <text x="585" y="74" textAnchor="middle" fill="#4ecca3" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">Physical RAM</text>

  <rect x="522" y="88" width="126" height="28" rx="5" fill="#0f3460" stroke="#4ecca3" strokeWidth="1"/>
  <text x="585" y="107" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">Frame 0 ← VP 4</text>

  <rect x="522" y="122" width="126" height="28" rx="5" fill="#16213e" stroke="#0f3460" strokeWidth="1" strokeDasharray="4,2"/>
  <text x="585" y="141" textAnchor="middle" fill="#888" fontSize="10" fontFamily="system-ui, sans-serif">Frame 1 (free)</text>

  <rect x="522" y="156" width="126" height="28" rx="5" fill="#0f3460" stroke="#4ecca3" strokeWidth="1"/>
  <text x="585" y="175" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">Frame 2 ← VP 1</text>

  <rect x="522" y="190" width="126" height="28" rx="5" fill="#0f3460" stroke="#4ecca3" strokeWidth="1"/>
  <text x="585" y="209" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">Frame 5 ← VP 0</text>

  <rect x="522" y="224" width="126" height="28" rx="5" fill="#0f3460" stroke="#4ecca3" strokeWidth="1"/>
  <text x="585" y="243" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">Frame 7 ← VP 2</text>

  {/* Disk / Swap */}
  <rect x="510" y="290" width="150" height="70" rx="8" fill="#1a1a2e" stroke="#e94560" strokeWidth="2"/>
  <text x="585" y="314" textAnchor="middle" fill="#e94560" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">Disk / Swap</text>
  <text x="585" y="334" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">VP 5 data stored</text>
  <text x="585" y="350" textAnchor="middle" fill="#888" fontSize="10" fontFamily="system-ui, sans-serif">~1-10ms to load</text>

  {/* Arrows: Virtual → Page Table */}
  <line x1="185" y1="122" x2="280" y2="122" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrowVM)"/>
  <line x1="185" y1="164" x2="280" y2="164" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrowVM)"/>
  <line x1="185" y1="206" x2="280" y2="206" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrowVM)"/>
  <line x1="185" y1="248" x2="280" y2="248" stroke="#e94560" strokeWidth="1.5" markerEnd="url(#arrowFault)"/>
  <line x1="185" y1="290" x2="280" y2="290" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrowVM)"/>
  <line x1="185" y1="332" x2="280" y2="332" stroke="#e94560" strokeWidth="1.5" markerEnd="url(#arrowFault)"/>

  {/* Arrows: Page Table → Physical */}
  <line x1="428" y1="122" x2="520" y2="210" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrowVM)"/>
  <line x1="428" y1="164" x2="520" y2="170" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrowVM)"/>
  <line x1="428" y1="206" x2="520" y2="238" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrowVM)"/>
  <line x1="428" y1="290" x2="520" y2="102" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrowVM)"/>

  {/* Arrow: Page Table → Disk (major fault) */}
  <line x1="428" y1="332" x2="520" y2="325" stroke="#e94560" strokeWidth="2" strokeDasharray="6,3" markerEnd="url(#arrowFault)"/>

  {/* Page Fault callout */}
  <rect x="690" y="215" width="100" height="80" rx="8" fill="#e94560" opacity="0.15" stroke="#e94560" strokeWidth="1.5"/>
  <text x="740" y="238" textAnchor="middle" fill="#e94560" fontSize="11" fontWeight="bold" fontFamily="system-ui, sans-serif">Page Fault</text>
  <text x="740" y="255" textAnchor="middle" fill="#e94560" fontSize="9" fontFamily="system-ui, sans-serif">Minor: ~1-10 us</text>
  <text x="740" y="268" textAnchor="middle" fill="#e94560" fontSize="9" fontFamily="system-ui, sans-serif">(data in RAM)</text>
  <text x="740" y="284" textAnchor="middle" fill="#e94560" fontSize="9" fontFamily="system-ui, sans-serif">Major: ~1-10 ms</text>

  {/* Legend */}
  <line x1="50" y1="385" x2="80" y2="385" stroke="#4ecca3" strokeWidth="2"/>
  <text x="86" y="389" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Valid mapping</text>
  <line x1="250" y1="385" x2="280" y2="385" stroke="#e94560" strokeWidth="2" strokeDasharray="5,3"/>
  <text x="286" y="389" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Page fault (not in RAM or invalid)</text>
  <rect x="540" y="379" width="12" height="12" rx="2" fill="#16213e" stroke="#0f3460" strokeWidth="1" strokeDasharray="3,2"/>
  <text x="558" y="390" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Free frame</text>
</svg>
</div>
