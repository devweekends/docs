...
19. How do you verify that AI-generated code is secure? Walk me through your process.
20. What is your approach to software supply chain security? How would you implement it from scratch?
21. How do you measure developer experience, and what is the difference between measuring tooling performance and developer satisfaction?
22. What is your take on AI coding agents? How would you introduce them safely into an engineering team's workflow?
23. A critical open-source dependency your team relies on is no longer maintained. What do you do?
24. How would you design a system that needs to run at the edge in 50+ locations? What changes compared to a centralized architecture?
...
The current generation of AI tools (Copilot, Claude, Cursor) operates as **co-pilots** --- they suggest, you decide. The next wave is **AI agents** that can execute multi-step workflows autonomously: read a bug report, find the relevant code, write a fix, run tests, open a PR.

**What is happening now:**
*   **Devin, SWE-Agent, OpenHands** --- AI agents that can navigate codebases, run terminal commands, and iterate on solutions. Still early, but the trajectory is clear
*   **Claude Code, GitHub Copilot Workspace** --- bridging the gap between suggestion and execution by giving AI tools the ability to read, plan, and act across files
*   **MCP (Model Context Protocol)** --- an emerging standard for giving AI agents structured access to external tools, APIs, and data sources. Think of it as the "USB-C for AI integrations"

**Why it matters for engineers:**
*   The skill shifts from "writing code" to "specifying intent, reviewing output, and designing systems that AI agents can safely operate on"
*   Teams will need to think about **agent-safe architectures** --- clear boundaries, reversible operations, comprehensive test suites that agents can run to verify their own work
*   Code review becomes even more critical when the author is non-human and may not understand the *why* behind architectural decisions
