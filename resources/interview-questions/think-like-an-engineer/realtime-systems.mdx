...
<svg viewBox="0 0 800 380" xmlns="http://www.w3.org/2000/svg" style={{maxWidth: '800px', width: '100%'}}>
  {/* Background */}
  <rect width="800" height="380" fill="#f5f5f5" rx="12"/>

  {/* Title */}
  <text x="400" y="30" textAnchor="middle" fill="#1a1a2e" fontSize="16" fontWeight="bold" fontFamily="system-ui, sans-serif">HTTP Request/Response vs WebSocket Persistent Connection</text>

  {/* HTTP Section */}
  <rect x="20" y="50" width="370" height="310" fill="#1a1a2e" rx="10"/>
  <text x="205" y="75" textAnchor="middle" fill="#f5f5f5" fontSize="14" fontWeight="bold" fontFamily="system-ui, sans-serif">Traditional HTTP</text>

  {/* HTTP Client */}
  <rect x="40" y="95" width="100" height="40" fill="#0f3460" rx="8"/>
  <text x="90" y="120" textAnchor="middle" fill="#f5f5f5" fontSize="13" fontFamily="system-ui, sans-serif">Client</text>

  {/* HTTP Server */}
  <rect x="270" y="95" width="100" height="40" fill="#0f3460" rx="8"/>
  <text x="320" y="120" textAnchor="middle" fill="#f5f5f5" fontSize="13" fontFamily="system-ui, sans-serif">Server</text>

  {/* HTTP Request 1 */}
  <line x1="140" y1="108" x2="270" y2="108" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrowRed)"/>
  <text x="205" y="103" textAnchor="middle" fill="#e94560" fontSize="10" fontFamily="system-ui, sans-serif">GET /data</text>

  {/* HTTP Response 1 */}
  <line x1="270" y1="125" x2="140" y2="125" stroke="#4ecca3" strokeWidth="2" markerEnd="url(#arrowGreen)"/>
  <text x="205" y="140" textAnchor="middle" fill="#4ecca3" fontSize="10" fontFamily="system-ui, sans-serif">200 OK + data</text>

  {/* Connection closed label */}
  <text x="205" y="160" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontStyle="italic" fontFamily="system-ui, sans-serif">connection closed</text>
  <line x1="60" y1="166" x2="350" y2="166" stroke="#f5f5f5" strokeWidth="1" strokeDasharray="4,4" opacity="0.4"/>

  {/* HTTP Request 2 */}
  <line x1="140" y1="185" x2="270" y2="185" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrowRed)"/>
  <text x="205" y="180" textAnchor="middle" fill="#e94560" fontSize="10" fontFamily="system-ui, sans-serif">GET /data</text>

  {/* HTTP Response 2 */}
  <line x1="270" y1="200" x2="140" y2="200" stroke="#4ecca3" strokeWidth="2" markerEnd="url(#arrowGreen)"/>
  <text x="205" y="215" textAnchor="middle" fill="#4ecca3" fontSize="10" fontFamily="system-ui, sans-serif">200 OK + data</text>

  {/* Connection closed label 2 */}
  <text x="205" y="235" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontStyle="italic" fontFamily="system-ui, sans-serif">connection closed</text>
  <line x1="60" y1="241" x2="350" y2="241" stroke="#f5f5f5" strokeWidth="1" strokeDasharray="4,4" opacity="0.4"/>

  {/* HTTP Request 3 */}
  <line x1="140" y1="260" x2="270" y2="260" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrowRed)"/>
  <text x="205" y="255" textAnchor="middle" fill="#e94560" fontSize="10" fontFamily="system-ui, sans-serif">GET /data</text>

  {/* HTTP Response 3 */}
  <line x1="270" y1="275" x2="140" y2="275" stroke="#4ecca3" strokeWidth="2" markerEnd="url(#arrowGreen)"/>
  <text x="205" y="290" textAnchor="middle" fill="#4ecca3" fontSize="10" fontFamily="system-ui, sans-serif">200 OK + data</text>

  {/* Connection closed label 3 */}
  <text x="205" y="310" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontStyle="italic" fontFamily="system-ui, sans-serif">connection closed</text>

  {/* HTTP overhead note */}
  <rect x="55" y="325" width="300" height="25" fill="#e94560" rx="6" opacity="0.2"/>
  <text x="205" y="342" textAnchor="middle" fill="#e94560" fontSize="11" fontFamily="system-ui, sans-serif">200-800 byte headers per request</text>

  {/* WebSocket Section */}
  <rect x="410" y="50" width="370" height="310" fill="#1a1a2e" rx="10"/>
  <text x="595" y="75" textAnchor="middle" fill="#f5f5f5" fontSize="14" fontWeight="bold" fontFamily="system-ui, sans-serif">WebSocket</text>

  {/* WS Client */}
  <rect x="430" y="95" width="100" height="40" fill="#0f3460" rx="8"/>
  <text x="480" y="120" textAnchor="middle" fill="#f5f5f5" fontSize="13" fontFamily="system-ui, sans-serif">Client</text>

  {/* WS Server */}
  <rect x="660" y="95" width="100" height="40" fill="#0f3460" rx="8"/>
  <text x="710" y="120" textAnchor="middle" fill="#f5f5f5" fontSize="13" fontFamily="system-ui, sans-serif">Server</text>

  {/* Upgrade handshake */}
  <line x1="530" y1="108" x2="660" y2="108" stroke="#533483" strokeWidth="2" markerEnd="url(#arrowPurple)"/>
  <text x="595" y="103" textAnchor="middle" fill="#533483" fontSize="10" fontFamily="system-ui, sans-serif">Upgrade: websocket</text>

  <line x1="660" y1="125" x2="530" y2="125" stroke="#533483" strokeWidth="2" markerEnd="url(#arrowPurple)"/>
  <text x="595" y="140" textAnchor="middle" fill="#533483" fontSize="10" fontFamily="system-ui, sans-serif">101 Switching Protocols</text>

  {/* Persistent connection indicator */}
  <rect x="525" y="152" width="140" height="20" fill="#4ecca3" rx="4" opacity="0.2"/>
  <text x="595" y="166" textAnchor="middle" fill="#4ecca3" fontSize="10" fontWeight="bold" fontFamily="system-ui, sans-serif">Connection Open</text>

  {/* Persistent connection line */}
  <line x1="480" y1="175" x2="480" y2="310" stroke="#4ecca3" strokeWidth="2" opacity="0.5"/>
  <line x1="710" y1="175" x2="710" y2="310" stroke="#4ecca3" strokeWidth="2" opacity="0.5"/>

  {/* Bidirectional messages */}
  <line x1="485" y1="190" x2="705" y2="190" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrowRed)"/>
  <text x="595" y="186" textAnchor="middle" fill="#e94560" fontSize="10" fontFamily="system-ui, sans-serif">message frame</text>

  <line x1="705" y1="210" x2="485" y2="210" stroke="#4ecca3" strokeWidth="2" markerEnd="url(#arrowGreen)"/>
  <text x="595" y="226" textAnchor="middle" fill="#4ecca3" fontSize="10" fontFamily="system-ui, sans-serif">message frame</text>

  <line x1="485" y1="240" x2="705" y2="240" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrowRed)"/>
  <text x="595" y="236" textAnchor="middle" fill="#e94560" fontSize="10" fontFamily="system-ui, sans-serif">message frame</text>

  <line x1="705" y1="260" x2="485" y2="260" stroke="#4ecca3" strokeWidth="2" markerEnd="url(#arrowGreen)"/>
  <text x="595" y="276" textAnchor="middle" fill="#4ecca3" fontSize="10" fontFamily="system-ui, sans-serif">message frame</text>

  <line x1="485" y1="290" x2="705" y2="290" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrowRed)"/>
  <text x="595" y="286" textAnchor="middle" fill="#e94560" fontSize="10" fontFamily="system-ui, sans-serif">ping/pong heartbeat</text>

  {/* WS overhead note */}
  <rect x="445" y="325" width="300" height="25" fill="#4ecca3" rx="6" opacity="0.2"/>
  <text x="595" y="342" textAnchor="middle" fill="#4ecca3" fontSize="11" fontFamily="system-ui, sans-serif">2-14 byte frame headers, single connection</text>
...
<svg viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg" style={{maxWidth: '800px', width: '100%'}}>
  ...
  {/* Title */}
  <text x="400" y="28" textAnchor="middle" fill="#1a1a2e" fontSize="15" fontWeight="bold" fontFamily="system-ui, sans-serif">Long Polling vs Server-Sent Events vs WebSocket -- Data Flow Comparison</text>

  {/* === Long Polling Column === */}
  <rect x="15" y="45" width="250" height="340" fill="#1a1a2e" rx="10"/>
  <text x="140" y="68" textAnchor="middle" fill="#e94560" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">Long Polling</text>

  {/* LP Client & Server */}
  <rect x="30" y="80" width="70" height="30" fill="#0f3460" rx="6"/>
  <text x="65" y="100" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Client</text>
  <rect x="180" y="80" width="70" height="30" fill="#0f3460" rx="6"/>
  <text x="215" y="100" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Server</text>

  {/* LP arrows - repeated request/response cycle */}
  <line x1="100" y1="122" x2="180" y2="122" stroke="#e94560" strokeWidth="1.5" markerEnd="url(#arrRed2)"/>
  <text x="140" y="118" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif">HTTP request</text>

  {/* Hold open */}
  <line x1="215" y1="127" x2="215" y2="150" stroke="#f5f5f5" strokeWidth="1" strokeDasharray="3,3" opacity="0.5"/>
  <text x="215" y="144" textAnchor="start" fill="#f5f5f5" fontSize="8" fontFamily="system-ui, sans-serif" dx="8">held open...</text>

  <line x1="180" y1="155" x2="100" y2="155" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrGreen2)"/>
  <text x="140" y="168" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">response + data</text>

  {/* Close marker */}
  <text x="140" y="183" textAnchor="middle" fill="#f5f5f5" fontSize="8" fontStyle="italic" fontFamily="system-ui, sans-serif" opacity="0.6">conn closed</text>

  {/* Repeat */}
  <line x1="100" y1="195" x2="180" y2="195" stroke="#e94560" strokeWidth="1.5" markerEnd="url(#arrRed2)"/>
  <text x="140" y="191" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif">HTTP request</text>

  <line x1="215" y1="200" x2="215" y2="223" stroke="#f5f5f5" strokeWidth="1" strokeDasharray="3,3" opacity="0.5"/>
  <text x="215" y="217" textAnchor="start" fill="#f5f5f5" fontSize="8" fontFamily="system-ui, sans-serif" dx="8">held open...</text>

  <line x1="180" y1="228" x2="100" y2="228" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrGreen2)"/>
  <text x="140" y="241" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">response + data</text>

  <text x="140" y="256" textAnchor="middle" fill="#f5f5f5" fontSize="8" fontStyle="italic" fontFamily="system-ui, sans-serif" opacity="0.6">conn closed</text>

  {/* LP repeated dots */}
  <text x="140" y="275" textAnchor="middle" fill="#f5f5f5" fontSize="14" fontFamily="system-ui, sans-serif" opacity="0.6">...</text>

  {/* LP Summary */}
  <rect x="30" y="290" width="220" height="42" fill="#16213e" rx="6"/>
  <text x="140" y="307" textAnchor="middle" fill="#e94560" fontSize="10" fontWeight="bold" fontFamily="system-ui, sans-serif">High overhead per cycle</text>
  <text x="140" y="322" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif">New connection each time, full HTTP headers</text>

  {/* LP direction badge */}
  <rect x="60" y="340" width="160" height="22" fill="#0f3460" rx="4"/>
  <text x="140" y="355" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">Server → Client (per poll)</text>

  {/* === SSE Column === */}
  <rect x="275" y="45" width="250" height="340" fill="#1a1a2e" rx="10"/>
  <text x="400" y="68" textAnchor="middle" fill="#533483" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">Server-Sent Events (SSE)</text>

  {/* SSE Client & Server */}
  <rect x="290" y="80" width="70" height="30" fill="#0f3460" rx="6"/>
  <text x="325" y="100" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Client</text>
  <rect x="440" y="80" width="70" height="30" fill="#0f3460" rx="6"/>
  <text x="475" y="100" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Server</text>

  {/* SSE initial request */}
  <line x1="360" y1="122" x2="440" y2="122" stroke="#533483" strokeWidth="1.5" markerEnd="url(#arrPurple2)"/>
  <text x="400" y="118" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif">GET /events (open)</text>

  {/* Persistent connection line for SSE */}
  <line x1="325" y1="135" x2="325" y2="280" stroke="#4ecca3" strokeWidth="1.5" opacity="0.3"/>
  <line x1="475" y1="135" x2="475" y2="280" stroke="#4ecca3" strokeWidth="1.5" opacity="0.3"/>

  {/* SSE server pushes */}
  <line x1="440" y1="150" x2="360" y2="150" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrGreen2)"/>
  <text x="400" y="146" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">event: data</text>

  <line x1="440" y1="178" x2="360" y2="178" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrGreen2)"/>
  <text x="400" y="174" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">event: data</text>

  <line x1="440" y1="206" x2="360" y2="206" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrGreen2)"/>
  <text x="400" y="202" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">event: data</text>

  <line x1="440" y1="234" x2="360" y2="234" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrGreen2)"/>
  <text x="400" y="230" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">event: data</text>

  <line x1="440" y1="262" x2="360" y2="262" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrGreen2)"/>
  <text x="400" y="258" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">event: data</text>

  {/* SSE Summary */}
  <rect x="290" y="290" width="220" height="42" fill="#16213e" rx="6"/>
  <text x="400" y="307" textAnchor="middle" fill="#4ecca3" fontSize="10" fontWeight="bold" fontFamily="system-ui, sans-serif">Persistent, auto-reconnect</text>
  <text x="400" y="322" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif">Single connection, event replay via ID</text>

  {/* SSE direction badge */}
  <rect x="320" y="340" width="160" height="22" fill="#0f3460" rx="4"/>
  <text x="400" y="355" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">Server → Client only</text>

  {/* === WebSocket Column === */}
  <rect x="535" y="45" width="250" height="340" fill="#1a1a2e" rx="10"/>
  <text x="660" y="68" textAnchor="middle" fill="#4ecca3" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">WebSocket</text>

  {/* WS Client & Server */}
  <rect x="550" y="80" width="70" height="30" fill="#0f3460" rx="6"/>
  <text x="585" y="100" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Client</text>
  <rect x="700" y="80" width="70" height="30" fill="#0f3460" rx="6"/>
  <text x="735" y="100" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Server</text>

  {/* WS handshake */}
  <line x1="620" y1="118" x2="700" y2="118" stroke="#533483" strokeWidth="1.5" markerEnd="url(#arrPurple2)"/>
  <text x="660" y="114" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif">Upgrade</text>
  <line x1="700" y1="130" x2="620" y2="130" stroke="#533483" strokeWidth="1.5" markerEnd="url(#arrPurple2)"/>
  <text x="660" y="143" textAnchor="middle" fill="#533483" fontSize="9" fontFamily="system-ui, sans-serif">101 Switching</text>

  {/* Persistent connection lines */}
  <line x1="585" y1="152" x2="585" y2="280" stroke="#4ecca3" strokeWidth="1.5" opacity="0.3"/>
  <line x1="735" y1="152" x2="735" y2="280" stroke="#4ecca3" strokeWidth="1.5" opacity="0.3"/>

  {/* Bidirectional messages */}
  <line x1="620" y1="165" x2="700" y2="165" stroke="#e94560" strokeWidth="1.5" markerEnd="url(#arrRed2)"/>
  <text x="660" y="161" textAnchor="middle" fill="#e94560" fontSize="9" fontFamily="system-ui, sans-serif">msg</text>

  <line x1="700" y1="185" x2="620" y2="185" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrGreen2)"/>
  <text x="660" y="198" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">msg</text>

  <line x1="620" y1="210" x2="700" y2="210" stroke="#e94560" strokeWidth="1.5" markerEnd="url(#arrRed2)"/>
  <text x="660" y="206" textAnchor="middle" fill="#e94560" fontSize="9" fontFamily="system-ui, sans-serif">msg</text>

  <line x1="700" y1="230" x2="620" y2="230" stroke="#4ecca3" strokeWidth="1.5" markerEnd="url(#arrGreen2)"/>
  <text x="660" y="243" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">msg</text>

  <line x1="620" y1="255" x2="700" y2="255" stroke="#e94560" strokeWidth="1.5" markerEnd="url(#arrRed2)"/>
  <text x="660" y="268" textAnchor="middle" fill="#e94560" fontSize="9" fontFamily="system-ui, sans-serif">msg</text>

  {/* WS Summary */}
  <rect x="550" y="290" width="220" height="42" fill="#16213e" rx="6"/>
  <text x="660" y="307" textAnchor="middle" fill="#4ecca3" fontSize="10" fontWeight="bold" fontFamily="system-ui, sans-serif">Full-duplex, low overhead</text>
  <text x="660" y="322" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif">2-14 byte frames, single connection</text>

  {/* WS direction badge */}
  <rect x="580" y="340" width="160" height="22" fill="#0f3460" rx="4"/>
  <text x="660" y="355" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif">Client ↔ Server</text>

  {/* Arrow markers */}
  <defs>
    <marker id="arrRed2" markerWidth="7" markerHeight="5" refX="7" refY="2.5" orient="auto">
      <path d="M0,0 L7,2.5 L0,5" fill="#e94560"/>
    </marker>
    <marker id="arrGreen2" markerWidth="7" markerHeight="5" refX="7" refY="2.5" orient="auto">
      <path d="M0,0 L7,2.5 L0,5" fill="#4ecca3"/>
    </marker>
    <marker id="arrPurple2" markerWidth="7" markerHeight="5" refX="7" refY="2.5" orient="auto">
      <path d="M0,0 L7,2.5 L0,5" fill="#533483"/>
    </marker>
  </defs>
</svg>
</div>
...
<svg viewBox="0 0 800 390" xmlns="http://www.w3.org/2000/svg" style={{maxWidth: '800px', width: '100%'}}>
  ...
  {/* Title */}
  <text x="400" y="28" textAnchor="middle" fill="#1a1a2e" fontSize="15" fontWeight="bold" fontFamily="system-ui, sans-serif">Real-Time Architecture: Pub/Sub Fan-Out Pattern</text>

  {/* === Clients Row === */}
  {/* Client A */}
  <rect x="20" y="55" width="90" height="45" fill="#0f3460" rx="8"/>
  <text x="65" y="74" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontWeight="bold" fontFamily="system-ui, sans-serif">Client A</text>
  <text x="65" y="90" textAnchor="middle" fill="#4ecca3" fontSize="9" fontFamily="system-ui, sans-serif">sends message</text>

  {/* Client B */}
  <rect x="225" y="55" width="90" height="45" fill="#0f3460" rx="8"/>
  <text x="270" y="74" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Client B</text>
  <text x="270" y="90" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif" opacity="0.7">subscriber</text>

  {/* Client C */}
  <rect x="485" y="55" width="90" height="45" fill="#0f3460" rx="8"/>
  <text x="530" y="74" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Client C</text>
  <text x="530" y="90" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif" opacity="0.7">subscriber</text>

  {/* Client D */}
  <rect x="690" y="55" width="90" height="45" fill="#0f3460" rx="8"/>
  <text x="735" y="74" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontFamily="system-ui, sans-serif">Client D</text>
  <text x="735" y="90" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif" opacity="0.7">subscriber</text>

  {/* WebSocket labels */}
  <text x="65" y="115" textAnchor="middle" fill="#533483" fontSize="9" fontFamily="system-ui, sans-serif">wss://</text>
  <text x="270" y="115" textAnchor="middle" fill="#533483" fontSize="9" fontFamily="system-ui, sans-serif">wss://</text>
  <text x="530" y="115" textAnchor="middle" fill="#533483" fontSize="9" fontFamily="system-ui, sans-serif">wss://</text>
  <text x="735" y="115" textAnchor="middle" fill="#533483" fontSize="9" fontFamily="system-ui, sans-serif">wss://</text>

  {/* Arrows from clients to WS servers */}
  <line x1="65" y1="120" x2="65" y2="150" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrR3)"/>
  <line x1="270" y1="120" x2="270" y2="150" stroke="#533483" strokeWidth="2" markerEnd="url(#arrP3)"/>
  <line x1="530" y1="120" x2="610" y2="150" stroke="#533483" strokeWidth="2" markerEnd="url(#arrP3)"/>
  <line x1="735" y1="120" x2="700" y2="150" stroke="#533483" strokeWidth="2" markerEnd="url(#arrP3)"/>

  {/* === WebSocket Servers Row === */}
  <rect x="15" y="152" width="170" height="50" fill="#1a1a2e" rx="8" stroke="#533483" strokeWidth="2"/>
  <text x="100" y="174" textAnchor="middle" fill="#f5f5f5" fontSize="12" fontWeight="bold" fontFamily="system-ui, sans-serif">WS Server 1</text>
  <text x="100" y="192" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif" opacity="0.7">Clients A, B connected</text>

  <rect x="220" y="152" width="170" height="50" fill="#1a1a2e" rx="8" stroke="#533483" strokeWidth="2"/>
  <text x="305" y="174" textAnchor="middle" fill="#f5f5f5" fontSize="12" fontWeight="bold" fontFamily="system-ui, sans-serif">WS Server 2</text>
  <text x="305" y="192" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif" opacity="0.7">idle (no relevant subs)</text>

  <rect x="570" y="152" width="195" height="50" fill="#1a1a2e" rx="8" stroke="#533483" strokeWidth="2"/>
  <text x="667" y="174" textAnchor="middle" fill="#f5f5f5" fontSize="12" fontWeight="bold" fontFamily="system-ui, sans-serif">WS Server 3</text>
  <text x="667" y="192" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif" opacity="0.7">Clients C, D connected</text>

  {/* Step 1 label */}
  <rect x="10" y="215" width="18" height="18" fill="#e94560" rx="9"/>
  <text x="19" y="228" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontWeight="bold" fontFamily="system-ui, sans-serif">1</text>
  <text x="38" y="228" textAnchor="start" fill="#1a1a2e" fontSize="10" fontFamily="system-ui, sans-serif">Client A sends message to #general channel</text>

  {/* Arrows from WS servers to broker */}
  <line x1="100" y1="202" x2="400" y2="262" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrR3)"/>
  <text x="230" y="240" textAnchor="middle" fill="#e94560" fontSize="9" fontWeight="bold" fontFamily="system-ui, sans-serif" transform="rotate(-10, 230, 240)">PUBLISH #general</text>

  {/* === Message Broker === */}
  <rect x="270" y="260" width="260" height="55" fill="#533483" rx="10" stroke="#4ecca3" strokeWidth="2"/>
  <text x="400" y="282" textAnchor="middle" fill="#f5f5f5" fontSize="13" fontWeight="bold" fontFamily="system-ui, sans-serif">Message Broker</text>
  <text x="400" y="302" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontFamily="system-ui, sans-serif" opacity="0.8">Redis Pub/Sub  |  Kafka  |  NATS</text>

  {/* Step 2 label */}
  <rect x="540" y="268" width="18" height="18" fill="#e94560" rx="9"/>
  <text x="549" y="281" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontWeight="bold" fontFamily="system-ui, sans-serif">2</text>
  <text x="567" y="281" textAnchor="start" fill="#1a1a2e" fontSize="10" fontFamily="system-ui, sans-serif">Broker fans out</text>

  {/* Arrows from broker to WS servers - fan out */}
  <line x1="335" y1="260" x2="100" y2="202" stroke="#4ecca3" strokeWidth="2" markerEnd="url(#arrG3)" strokeDasharray="6,3"/>
  <line x1="400" y1="260" x2="305" y2="202" stroke="#4ecca3" strokeWidth="2" markerEnd="url(#arrG3)" strokeDasharray="6,3"/>
  <line x1="465" y1="260" x2="667" y2="202" stroke="#4ecca3" strokeWidth="2" markerEnd="url(#arrG3)" strokeDasharray="6,3"/>

  {/* Step 3 label */}
  <rect x="10" y="330" width="18" height="18" fill="#e94560" rx="9"/>
  <text x="19" y="343" textAnchor="middle" fill="#f5f5f5" fontSize="11" fontWeight="bold" fontFamily="system-ui, sans-serif">3</text>
  <text x="38" y="343" textAnchor="start" fill="#1a1a2e" fontSize="10" fontFamily="system-ui, sans-serif">Each WS server pushes to its locally connected subscribers for #general</text>

  {/* Return arrows from servers to clients (subscriber delivery) */}
  <path d="M100,152 L100,142 Q100,137 95,137 L78,137 Q73,137 73,132 L73,100" stroke="#4ecca3" strokeWidth="1.5" fill="none" markerEnd="url(#arrG3)" strokeDasharray="4,3" opacity="0.6"/>
  <path d="M175,155 L260,142 Q265,141 265,136 L265,100" stroke="#4ecca3" strokeWidth="1.5" fill="none" markerEnd="url(#arrG3)" strokeDasharray="4,3" opacity="0.6"/>
  <path d="M625,155 L540,142 Q535,141 535,136 L535,100" stroke="#4ecca3" strokeWidth="1.5" fill="none" markerEnd="url(#arrG3)" strokeDasharray="4,3" opacity="0.6"/>
  <path d="M720,152 L720,142 Q720,137 725,137 L745,137 Q750,137 750,132 L750,100" stroke="#4ecca3" strokeWidth="1.5" fill="none" markerEnd="url(#arrG3)" strokeDasharray="4,3" opacity="0.6"/>

  {/* Connection Registry */}
  <rect x="280" y="340" width="240" height="40" fill="#16213e" rx="8" stroke="#1a1a2e" strokeWidth="1"/>
  <text x="400" y="357" textAnchor="middle" fill="#f5f5f5" fontSize="10" fontWeight="bold" fontFamily="system-ui, sans-serif">Connection Registry (Redis)</text>
  <text x="400" y="372" textAnchor="middle" fill="#f5f5f5" fontSize="9" fontFamily="system-ui, sans-serif" opacity="0.7">user → server mapping, channel subscriptions</text>

  {/* Arrow markers */}
  <defs>
    <marker id="arrR3" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <path d="M0,0 L8,3 L0,6" fill="#e94560"/>
    </marker>
    <marker id="arrG3" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <path d="M0,0 L8,3 L0,6" fill="#4ecca3"/>
    </marker>
    <marker id="arrP3" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <path d="M0,0 L8,3 L0,6" fill="#533483"/>
    </marker>
  </defs>
</svg>
