...
<svg viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg" style={{maxWidth: '800px', width: '100%'}}>
  <defs>
    <marker id="arrow-ethics" viewBox="0 0 10 7" refX="9" refY="3.5" markerWidth="10" markerHeight="7" orient="auto-start-reverse">
      <polygon points="0 0, 10 3.5, 0 7" fill="#e94560"/>
    </marker>
    <marker id="arrow-green" viewBox="0 0 10 7" refX="9" refY="3.5" markerWidth="10" markerHeight="7" orient="auto-start-reverse">
      <polygon points="0 0, 10 3.5, 0 7" fill="#4ecca3"/>
    </marker>
    <marker id="arrow-red" viewBox="0 0 10 7" refX="9" refY="3.5" markerWidth="10" markerHeight="7" orient="auto-start-reverse">
      <polygon points="0 0, 10 3.5, 0 7" fill="#e94560"/>
    </marker>
  </defs>

  <text x="400" y="28" textAnchor="middle" fill="#1a1a2e" fontSize="18" fontWeight="bold" fontFamily="sans-serif">Ethics Decision Framework for Engineering Choices</text>

  {/* Start node */}
  <rect x="310" y="45" width="180" height="40" rx="20" fill="#1a1a2e" stroke="#1a1a2e" strokeWidth="2"/>
  <text x="400" y="70" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold" fontFamily="sans-serif">New Feature / Decision</text>

  <line x1="400" y1="85" x2="400" y2="105" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrow-ethics)"/>

  {/* Question 1 */}
  <polygon points="400,105 530,145 400,185 270,145" fill="#0f3460" stroke="#0f3460" strokeWidth="1"/>
  <text x="400" y="141" textAnchor="middle" fill="white" fontSize="12" fontWeight="bold" fontFamily="sans-serif">Who could be</text>
  <text x="400" y="155" textAnchor="middle" fill="white" fontSize="12" fontWeight="bold" fontFamily="sans-serif">harmed?</text>

  {/* No harm path */}
  <line x1="530" y1="145" x2="620" y2="145" stroke="#4ecca3" strokeWidth="2" markerEnd="url(#arrow-green)"/>
  <rect x="625" y="125" width="145" height="40" rx="8" fill="#4ecca3"/>
  <text x="697" y="148" textAnchor="middle" fill="#1a1a2e" fontSize="11" fontWeight="bold" fontFamily="sans-serif">Low risk: proceed</text>
  <text x="697" y="160" textAnchor="middle" fill="#1a1a2e" fontSize="11" fontWeight="bold" fontFamily="sans-serif">with documentation</text>
  <text x="575" y="138" fill="#4ecca3" fontSize="11" fontFamily="sans-serif">No one</text>

  {/* Harm identified path */}
  <line x1="400" y1="185" x2="400" y2="205" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrow-ethics)"/>
  <text x="420" y="198" fill="#e94560" fontSize="11" fontFamily="sans-serif">Harm identified</text>

  {/* Question 2 */}
  <polygon points="400,205 540,245 400,285 260,245" fill="#0f3460" stroke="#0f3460" strokeWidth="1"/>
  <text x="400" y="241" textAnchor="middle" fill="white" fontSize="12" fontWeight="bold" fontFamily="sans-serif">Is the data</text>
  <text x="400" y="255" textAnchor="middle" fill="white" fontSize="12" fontWeight="bold" fontFamily="sans-serif">consented + necessary?</text>

  {/* No consent path */}
  <line x1="260" y1="245" x2="145" y2="245" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrow-red)"/>
  <rect x="15" y="222" width="125" height="46" rx="8" fill="#e94560"/>
  <text x="77" y="242" textAnchor="middle" fill="white" fontSize="11" fontWeight="bold" fontFamily="sans-serif">STOP: Redesign</text>
  <text x="77" y="256" textAnchor="middle" fill="white" fontSize="11" fontWeight="bold" fontFamily="sans-serif">or get consent</text>
  <text x="200" y="238" fill="#e94560" fontSize="11" fontFamily="sans-serif">No</text>

  {/* Yes path down */}
  <line x1="400" y1="285" x2="400" y2="305" stroke="#4ecca3" strokeWidth="2" markerEnd="url(#arrow-green)"/>
  <text x="415" y="298" fill="#4ecca3" fontSize="11" fontFamily="sans-serif">Yes</text>

  {/* Question 3 */}
  <polygon points="400,305 540,345 400,385 260,345" fill="#533483" stroke="#533483" strokeWidth="1"/>
  <text x="400" y="338" textAnchor="middle" fill="white" fontSize="12" fontWeight="bold" fontFamily="sans-serif">What if it leaks?</text>
  <text x="400" y="352" textAnchor="middle" fill="white" fontSize="12" fontWeight="bold" fontFamily="sans-serif">Power asymmetry?</text>

  {/* Severe path */}
  <line x1="260" y1="345" x2="145" y2="345" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrow-red)"/>
  <rect x="15" y="322" width="125" height="46" rx="8" fill="#e94560"/>
  <text x="77" y="342" textAnchor="middle" fill="white" fontSize="11" fontWeight="bold" fontFamily="sans-serif">STOP: Ethics</text>
  <text x="77" y="356" textAnchor="middle" fill="white" fontSize="11" fontWeight="bold" fontFamily="sans-serif">review required</text>
  <text x="195" y="338" fill="#e94560" fontSize="11" fontFamily="sans-serif">Severe</text>

  {/* Acceptable path */}
  <line x1="540" y1="345" x2="625" y2="345" stroke="#4ecca3" strokeWidth="2" markerEnd="url(#arrow-green)"/>
  <rect x="625" y="322" width="155" height="46" rx="8" fill="#4ecca3"/>
  <text x="702" y="340" textAnchor="middle" fill="#1a1a2e" fontSize="11" fontWeight="bold" fontFamily="sans-serif">PROCEED: Document</text>
  <text x="702" y="354" textAnchor="middle" fill="#1a1a2e" fontSize="11" fontWeight="bold" fontFamily="sans-serif">reasoning + monitor</text>
  <text x="575" y="338" fill="#4ecca3" fontSize="11" fontFamily="sans-serif">Acceptable</text>
</svg>
</div>
...
<svg viewBox="0 0 800 380" xmlns="http://www.w3.org/2000/svg" style={{maxWidth: '800px', width: '100%'}}>
  <defs>
    <marker id="arrow-bias" viewBox="0 0 10 7" refX="9" refY="3.5" markerWidth="10" markerHeight="7" orient="auto-start-reverse">
      <polygon points="0 0, 10 3.5, 0 7" fill="#e94560"/>
    </marker>
    <marker id="arrow-feedback" viewBox="0 0 10 7" refX="9" refY="3.5" markerWidth="10" markerHeight="7" orient="auto-start-reverse">
      <polygon points="0 0, 10 3.5, 0 7" fill="#533483"/>
    </marker>
  </defs>

  <text x="400" y="28" textAnchor="middle" fill="#1a1a2e" fontSize="18" fontWeight="bold" fontFamily="sans-serif">Where Bias Enters the AI/ML Pipeline</text>

  {/* Stage 1: Data Collection */}
  <rect x="20" y="60" width="130" height="70" rx="8" fill="#1a1a2e"/>
  <text x="85" y="85" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold" fontFamily="sans-serif">Data</text>
  <text x="85" y="100" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold" fontFamily="sans-serif">Collection</text>
  {/* Bias label 1 */}
  <rect x="10" y="140" width="150" height="52" rx="6" fill="#f5f5f5" stroke="#e94560" strokeWidth="1.5"/>
  <text x="85" y="157" textAnchor="middle" fill="#e94560" fontSize="10" fontWeight="bold" fontFamily="sans-serif">Selection Bias</text>
  <text x="85" y="170" textAnchor="middle" fill="#1a1a2e" fontSize="9.5" fontFamily="sans-serif">Underrepresentation of</text>
  <text x="85" y="182" textAnchor="middle" fill="#1a1a2e" fontSize="9.5" fontFamily="sans-serif">demographics in dataset</text>

  {/* Arrow 1-2 */}
  <line x1="150" y1="95" x2="175" y2="95" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrow-bias)"/>

  {/* Stage 2: Feature Engineering */}
  <rect x="180" y="60" width="130" height="70" rx="8" fill="#16213e"/>
  <text x="245" y="85" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold" fontFamily="sans-serif">Feature</text>
  <text x="245" y="100" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold" fontFamily="sans-serif">Engineering</text>
  {/* Bias label 2 */}
  <rect x="170" y="140" width="150" height="52" rx="6" fill="#f5f5f5" stroke="#e94560" strokeWidth="1.5"/>
  <text x="245" y="157" textAnchor="middle" fill="#e94560" fontSize="10" fontWeight="bold" fontFamily="sans-serif">Proxy Variables</text>
  <text x="245" y="170" textAnchor="middle" fill="#1a1a2e" fontSize="9.5" fontFamily="sans-serif">Zip code, name, school</text>
  <text x="245" y="182" textAnchor="middle" fill="#1a1a2e" fontSize="9.5" fontFamily="sans-serif">encode protected traits</text>

  {/* Arrow 2-3 */}
  <line x1="310" y1="95" x2="335" y2="95" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrow-bias)"/>

  {/* Stage 3: Model Training */}
  <rect x="340" y="60" width="130" height="70" rx="8" fill="#0f3460"/>
  <text x="405" y="85" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold" fontFamily="sans-serif">Model</text>
  <text x="405" y="100" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold" fontFamily="sans-serif">Training</text>
  {/* Bias label 3 */}
  <rect x="330" y="140" width="150" height="52" rx="6" fill="#f5f5f5" stroke="#e94560" strokeWidth="1.5"/>
  <text x="405" y="157" textAnchor="middle" fill="#e94560" fontSize="10" fontWeight="bold" fontFamily="sans-serif">Historical Bias</text>
  <text x="405" y="170" textAnchor="middle" fill="#1a1a2e" fontSize="9.5" fontFamily="sans-serif">Model learns patterns</text>
  <text x="405" y="182" textAnchor="middle" fill="#1a1a2e" fontSize="9.5" fontFamily="sans-serif">from a biased world</text>

  {/* Arrow 3-4 */}
  <line x1="470" y1="95" x2="495" y2="95" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrow-bias)"/>

  {/* Stage 4: Deployment */}
  <rect x="500" y="60" width="130" height="70" rx="8" fill="#533483"/>
  <text x="565" y="85" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold" fontFamily="sans-serif">Production</text>
  <text x="565" y="100" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold" fontFamily="sans-serif">Deployment</text>
  {/* Bias label 4 */}
  <rect x="490" y="140" width="150" height="52" rx="6" fill="#f5f5f5" stroke="#e94560" strokeWidth="1.5"/>
  <text x="565" y="157" textAnchor="middle" fill="#e94560" fontSize="10" fontWeight="bold" fontFamily="sans-serif">Automation Bias</text>
  <text x="565" y="170" textAnchor="middle" fill="#1a1a2e" fontSize="9.5" fontFamily="sans-serif">Humans over-trust</text>
  <text x="565" y="182" textAnchor="middle" fill="#1a1a2e" fontSize="9.5" fontFamily="sans-serif">algorithmic output</text>

  {/* Arrow 4-5 */}
  <line x1="630" y1="95" x2="655" y2="95" stroke="#e94560" strokeWidth="2" markerEnd="url(#arrow-bias)"/>

  {/* Stage 5: Outcomes */}
  <rect x="660" y="60" width="120" height="70" rx="8" fill="#e94560"/>
  <text x="720" y="85" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold" fontFamily="sans-serif">Real-World</text>
  <text x="720" y="100" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold" fontFamily="sans-serif">Outcomes</text>
  {/* Bias label 5 */}
  <rect x="650" y="140" width="140" height="52" rx="6" fill="#f5f5f5" stroke="#e94560" strokeWidth="1.5"/>
  <text x="720" y="157" textAnchor="middle" fill="#e94560" fontSize="10" fontWeight="bold" fontFamily="sans-serif">Disparate Impact</text>
  <text x="720" y="170" textAnchor="middle" fill="#1a1a2e" fontSize="9.5" fontFamily="sans-serif">Discriminatory decisions</text>
  <text x="720" y="182" textAnchor="middle" fill="#1a1a2e" fontSize="9.5" fontFamily="sans-serif">at scale</text>

  {/* Feedback loop arrow - curved path going below */}
  <path d="M 720 130 L 720 230 C 720 260 700 280 670 280 L 130 280 C 100 280 80 260 80 230 L 80 135" fill="none" stroke="#533483" strokeWidth="2.5" strokeDasharray="8,4" markerEnd="url(#arrow-feedback)"/>

  {/* Feedback loop label */}
  <rect x="290" y="260" width="220" height="36" rx="8" fill="#533483"/>
  <text x="400" y="276" textAnchor="middle" fill="white" fontSize="11" fontWeight="bold" fontFamily="sans-serif">FEEDBACK LOOP: Biased outcomes</text>
  <text x="400" y="289" textAnchor="middle" fill="white" fontSize="11" fontWeight="bold" fontFamily="sans-serif">become next cycle's training data</text>

  {/* Mitigation bar at bottom */}
  <rect x="50" y="320" width="700" height="48" rx="8" fill="#4ecca3" opacity="0.15" stroke="#4ecca3" strokeWidth="1.5"/>
  <text x="400" y="340" textAnchor="middle" fill="#1a1a2e" fontSize="12" fontWeight="bold" fontFamily="sans-serif">Mitigation at Every Stage: Diverse data | Proxy detection | Fairness constraints | Human-in-the-loop | Bias monitoring</text>
  <text x="400" y="356" textAnchor="middle" fill="#1a1a2e" fontSize="11" fontFamily="sans-serif">Algorithmic auditing (Section 2.5) is an ongoing discipline, not a one-time check</text>
</svg>
</div>
...
<div style={{textAlign: 'center', margin: '2rem 0'}}>
<svg viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg" style={{maxWidth: '800px', width: '100%'}}>
  <text x="400" y="28" textAnchor="middle" fill="#1a1a2e" fontSize="18" fontWeight="bold" fontFamily="sans-serif">Privacy by Design: Layered Protection Architecture</text>

  {/* Outermost layer - System Boundary */}
  <rect x="40" y="48" width="720" height="340" rx="16" fill="#1a1a2e" opacity="0.06" stroke="#1a1a2e" strokeWidth="2"/>
  <text x="400" y="72" textAnchor="middle" fill="#1a1a2e" fontSize="13" fontWeight="bold" fontFamily="sans-serif">LAYER 1: Organizational Policies and Compliance (GDPR, HIPAA, CCPA)</text>

  {/* Second layer - Infrastructure */}
  <rect x="80" y="82" width="640" height="290" rx="14" fill="#16213e" opacity="0.1" stroke="#16213e" strokeWidth="2"/>
  <text x="400" y="104" textAnchor="middle" fill="#16213e" fontSize="13" fontWeight="bold" fontFamily="sans-serif">LAYER 2: Infrastructure Security (Encryption at Rest + in Transit, Zero Trust)</text>

  {/* Third layer - Application */}
  <rect x="120" y="114" width="560" height="242" rx="12" fill="#0f3460" opacity="0.1" stroke="#0f3460" strokeWidth="2"/>
  <text x="400" y="136" textAnchor="middle" fill="#0f3460" fontSize="13" fontWeight="bold" fontFamily="sans-serif">LAYER 3: Application Controls (Access Control, Audit Logging, Consent Management)</text>

  {/* Fourth layer - Data Processing */}
  <rect x="160" y="146" width="480" height="194" rx="10" fill="#533483" opacity="0.1" stroke="#533483" strokeWidth="2"/>
  <text x="400" y="168" textAnchor="middle" fill="#533483" fontSize="13" fontWeight="bold" fontFamily="sans-serif">LAYER 4: Data Processing (Minimization, Anonymization, Differential Privacy)</text>

  {/* Inner core - User Data */}
  <rect x="240" y="185" width="320" height="140" rx="10" fill="white" stroke="#4ecca3" strokeWidth="3"/>

  {/* User data icon area */}
  <rect x="260" y="200" width="130" height="110" rx="8" fill="#4ecca3" opacity="0.15"/>
  <text x="325" y="225" textAnchor="middle" fill="#1a1a2e" fontSize="12" fontWeight="bold" fontFamily="sans-serif">User Data</text>

  {/* User icon */}
  <circle cx="305" cy="258" r="14" fill="#4ecca3" opacity="0.4"/>
  <circle cx="305" cy="252" r="6" fill="#1a1a2e"/>
  <path d="M 293 268 C 293 260 317 260 317 268" fill="#1a1a2e"/>
  <circle cx="345" cy="258" r="14" fill="#4ecca3" opacity="0.4"/>
  <circle cx="345" cy="252" r="6" fill="#1a1a2e"/>
  <path d="M 333 268 C 333 260 357 260 357 268" fill="#1a1a2e"/>

  <text x="325" y="296" textAnchor="middle" fill="#1a1a2e" fontSize="9.5" fontFamily="sans-serif">Minimal, consented,</text>
  <text x="325" y="307" textAnchor="middle" fill="#1a1a2e" fontSize="9.5" fontFamily="sans-serif">purpose-limited</text>

  {/* Right side - Protection techniques */}
  <rect x="405" y="200" width="140" height="110" rx="8" fill="#f5f5f5"/>
  <text x="475" y="218" textAnchor="middle" fill="#1a1a2e" fontSize="11" fontWeight="bold" fontFamily="sans-serif">Protection Techniques</text>
  <line x1="415" y1="224" x2="535" y2="224" stroke="#e0e0e0" strokeWidth="1"/>

  <circle cx="420" cy="240" r="4" fill="#4ecca3"/>
  <text x="430" y="244" fill="#1a1a2e" fontSize="10" fontFamily="sans-serif">On-device processing</text>

  <circle cx="420" cy="258" r="4" fill="#4ecca3"/>
  <text x="430" y="262" fill="#1a1a2e" fontSize="10" fontFamily="sans-serif">Federated learning</text>

  <circle cx="420" cy="276" r="4" fill="#4ecca3"/>
  <text x="430" y="280" fill="#1a1a2e" fontSize="10" fontFamily="sans-serif">Crypto-shredding</text>

  <circle cx="420" cy="294" r="4" fill="#4ecca3"/>
  <text x="430" y="298" fill="#1a1a2e" fontSize="10" fontFamily="sans-serif">Homomorphic enc.</text>

  {/* Principle labels on the sides */}
  {/* Left side principles */}
  <rect x="44" y="168" width="105" height="30" rx="6" fill="#1a1a2e"/>
  <text x="96" y="187" textAnchor="middle" fill="white" fontSize="9.5" fontWeight="bold" fontFamily="sans-serif">Proactive, not</text>
  <text x="96" y="197" textAnchor="middle" fill="white" fontSize="9.5" fontWeight="bold" fontFamily="sans-serif"/>

  <rect x="44" y="210" width="105" height="24" rx="6" fill="#16213e"/>
  <text x="96" y="226" textAnchor="middle" fill="white" fontSize="9.5" fontWeight="bold" fontFamily="sans-serif">Privacy as default</text>

  <rect x="44" y="246" width="105" height="24" rx="6" fill="#0f3460"/>
  <text x="96" y="262" textAnchor="middle" fill="white" fontSize="9.5" fontWeight="bold" fontFamily="sans-serif">Embedded in design</text>

  <rect x="44" y="282" width="105" height="24" rx="6" fill="#533483"/>
  <text x="96" y="298" textAnchor="middle" fill="white" fontSize="9.5" fontWeight="bold" fontFamily="sans-serif">Full functionality</text>

  {/* Right side principles */}
  <rect x="652" y="168" width="105" height="30" rx="6" fill="#1a1a2e"/>
  <text x="704" y="187" textAnchor="middle" fill="white" fontSize="9.5" fontWeight="bold" fontFamily="sans-serif">End-to-end</text>
  <text x="704" y="197" textAnchor="middle" fill="white" fontSize="9.5" fontWeight="bold" fontFamily="sans-serif"/>

  <rect x="652" y="210" width="105" height="24" rx="6" fill="#16213e"/>
  <text x="704" y="226" textAnchor="middle" fill="white" fontSize="9.5" fontWeight="bold" fontFamily="sans-serif">Transparency</text>

  <rect x="652" y="246" width="105" height="24" rx="6" fill="#0f3460"/>
  <text x="704" y="262" textAnchor="middle" fill="white" fontSize="9.5" fontWeight="bold" fontFamily="sans-serif">User respect</text>

  {/* Connecting dashes from principles to layers */}
  <line x1="149" y1="183" x2="160" y2="183" stroke="#1a1a2e" strokeWidth="1" strokeDasharray="3,2"/>
  <line x1="149" y1="222" x2="160" y2="222" stroke="#16213e" strokeWidth="1" strokeDasharray="3,2"/>
  <line x1="149" y1="258" x2="160" y2="258" stroke="#0f3460" strokeWidth="1" strokeDasharray="3,2"/>
  <line x1="149" y1="294" x2="160" y2="294" stroke="#533483" strokeWidth="1" strokeDasharray="3,2"/>
  <line x1="652" y1="183" x2="640" y2="183" stroke="#1a1a2e" strokeWidth="1" strokeDasharray="3,2"/>
  <line x1="652" y1="222" x2="640" y2="222" stroke="#16213e" strokeWidth="1" strokeDasharray="3,2"/>
  <line x1="652" y1="258" x2="640" y2="258" stroke="#0f3460" strokeWidth="1" strokeDasharray="3,2"/>

  {/* Bottom annotation */}
  <text x="400" y="395" textAnchor="middle" fill="#1a1a2e" fontSize="11" fontFamily="sans-serif" fontStyle="italic">Each layer independently protects user data. A breach must penetrate all layers to cause harm.</text>
</svg>
</div>
