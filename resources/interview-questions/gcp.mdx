...
**Cost trap**: A function invoked 10M times/month at 256MB, 200ms avg duration costs ~$40/month. The same workload on a single `e2-small` Cloud Run instance costs ~$15/month. Functions are cheaper only at low, sporadic invocation rates.
