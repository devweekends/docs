...
<AccordionGroup>
  <Accordion title="Your team wants to use GPT-4o to generate training data for a smaller model. Walk me through the end-to-end pipeline and the specific failure modes at each stage.">
    **Strong Answer:**
  ...
  <Accordion title="When is synthetic data a bad idea? What are the specific scenarios where you should invest in real data collection instead?">
    ...
    **Follow-up: You have 50 real labeled examples and need 5,000 to fine-tune. Is the right approach 4,950 synthetic examples, or is there a better ratio?**
  ...
  <Accordion title="You are using an LLM to judge the quality of data generated by another LLM. Isn't this circular? How do you ensure the judge is actually catching bad examples?">
    **Strong Answer:**
