  ...
  <Accordion title="Q5: Longest Increasing Subsequence has an O(n^2) DP solution and an O(n log n) solution. Explain both and when you'd choose each." icon="arrow-up">
    ...
    **Strong answer:**
    ...
    - **When to choose which:**
      - O(n^2): simpler to code, easier to explain, sufficient for n <= 5000 or so. Also easier to adapt for variants (e.g., longest non-decreasing subsequence, count of LIS, etc.).
