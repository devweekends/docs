...
<img
  ...
  src="/images/engineering/architecture-patterns.png"
  alt="Architecture Patterns"
/>
...
<Tip>
**Interview Tip**: Always discuss trade-offs. There's no "best" architecture—only the right one for your context.
</Tip>
