...
![IPC Mechanisms Overview](/images/courses/ipc-mechanisms.svg)
...
![IPC Performance Comparison](/images/courses/ipc-performance.svg)
...
<AccordionGroup>
  <Accordion title="Q1: Design IPC for a web server with worker processes">
    ...
    **Architecture** (like Nginx):
    ![Web Server IPC Architecture](/images/courses/web-server-ipc.svg)
  ...
  <Accordion title="Q4: How does Chrome isolate tabs using IPC?">
    ...
    **Chrome's multi-process architecture**:
    ...
    ![Chrome Multi-Process Architecture](/images/courses/chrome-architecture.svg)
