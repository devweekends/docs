...
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│  Available: 3 resources                                         │
│                                                                  │
│  Process  Has    Max    Needs                                   │
│  ───────  ───    ───    ─────                                   │
│    P0      1      4       3                                     │
│    P1      2      6       4                                     │
│    P2      1      3       2                                     │
...
│  1. Give P2 2 more → P2 finishes → returns 3 → Available=6     │
│  2. Give P0 3 more → P0 finishes → returns 4 → Available=10    │
│  3. Give P1 4 more → P1 finishes → Available=12                │
│                                                                  │
│  If P0 requests 1 more:                                         │
│  Available becomes 2. Can any process finish?                   │
│  - P2 needs 2: YES → After P2: Available=5                     │
│  - P0 needs 2 (now): YES → After P0: Available=7               │
│  - P1 needs 4: YES                                              │
│  Still safe! Grant the request.                                 │
│                                                                  │
│  UNSAFE STATE:                                                  │
│  If grant would leave no safe sequence → Deny request          │
│                                                                  │
└─────────────────────────────────────────────────────────────────┘
```
