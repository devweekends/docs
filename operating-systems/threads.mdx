...
│  ◉ Data segment                   ◉ Stack                       │
│  ◉ Heap                           ◉ Registers                   │
│  ◉ Open file descriptors          ◉ Program Counter             │
│  ◉ Signal handlers                ◉ Stack Pointer               │
│  ◉ Current working directory      ◉ Thread-local storage (TLS)  │
│  ◉ User/Group ID                  ◉ errno (in most impls)       │
│  ◉ Address space mappings         ◉ Signal mask                 │
│                                                                  │
│  ┌─────────┐ ┌─────────┐ ┌─────────┐                           │
...
│           ↓      ↓      ↓      ↓                               │
│        ┌────┐  ┌────┐  ┌────┐  ┌────┐                          │
│        │CPU0│  │CPU1│  │CPU0│  │CPU2│   (scheduled by kernel)  │
│        └────┘  └────┘  └────┘  └────┘                          │
└─────────────────────────────────────────────────────────────────┘
```
...
│                                                                  │
│     ┌────┐ ┌────┐ ┌────┐ ┌────┐ ┌────┐ ┌────┐                 │
│     │UT1 │ │UT2 │ │UT3 │ │UT4 │ │UT5 │ │UT6 │   (M=6 user)   │
│     └──┬─┘ └──┬─┘ └──┬─┘ └──┬─┘ └──┬─┘ └──┬─┘                 │
│        │      │      │      │      │      │                     │
│        └──────┴──────┼──────┴──────┼──────┘                     │
│                      │             │         M:N multiplexing   │
